...
readonly ANDROID_NDK_ROOT="/home/user/Android/Sdk/ndk/27.2.12479018"
...
function cross_compile_openssl() {
  ...
  if [[ "${target}" == 'aarch64-linux-android' ]]; then
    ...
    ./Configure android-arm -D__ANDROID_API__=${API}
  elif [[ "${target}" == 'i686-linux-android' ]]; then
    ./Configure android-x86 -D__ANDROID_API__=${API}
  elif [[ "${target}" == 'x86_64-linux-android' ]]; then
    ./Configure android-x86_64 -D__ANDROID_API__=${API}
  fi
